#!/usr/bin/env python3
"""
test_fungibility_matrix_cpu.py
==============================
Runs a 3x3 matrix experiment to prove the fungibility of the CPU "unit of measure".
It tests combinations of Background CPU_MODE and Probe CPU_MODE, proving that 
...
# The 3 CPU modes (ALU arithmetic, FPU float, hashing)
BG_MODES = ["cpu_int", "cpu_fp", "cpu_hash"]
PROBE_MODES = ["cpu_int", "cpu_fp", "cpu_hash"]
...
def main():
    ...
    parser.add_argument("--capacities", type=str, default=None,
                        help="JSON string or comma-separated key-value list of capacities, e.g., 'cpu_int:200,cpu_fp:150'")
